...
namespace WorldMapStrategyKit
{
	public static class GUIResizer
	{
		...
		private static Vector2 resizeRatio;
		...
		public static void Init(int screenWidth, int screenHeight)
		{
			...
			resizeRatio = new Vector2((float)Screen.width / authoredScreenWidth,
				(float)Screen.height / authoredScreenHeight);
		}

		public static void AutoResize()
		{
			if (resizeRatio.x != 0)
				GUI.matrix = Matrix4x4.TRS(Misc.Vector3zero, Quaternion.identity,
