...
namespace WorldMapStrategyKit.ClipperLib
{
  ...
  using cInt = Int32;
	...
	public class ClipperBase
	{
		...
		internal static bool near_zero(double val) => val > -tolerance && val < tolerance;
    ...
    public const cInt hiRange = 0x7FFF;
		...
		internal static bool IsHorizontal(TEdge e) => e.Delta.Y == 0;
		//------------------------------------------------------------------------------
      ...
      Swap(ref e.Top.Z, ref e.Bot.Z);
		...
		internal bool LocalMinimaPending() => m_CurrentLM != null;
		//------------------------------------------------------------------------------
	...
	public partial class Clipper : ClipperBase
	{
      ...
      //------------------------------------------------------------------------------
		...
		private OutPt GetBottomPt(OutPt pp)
		{
			...
			if (dups != null) //there appears to be at least 2 vertices at bottomPt so ...
				while (dups != p)
				{
		...
		internal static long Round(double value) => value < 0 ? (long)(value - 0.5) : (long)(value + 0.5);
		//------------------------------------------------------------------------------
		...
		public static bool Orientation(Path poly) => Area(poly) >= 0;
		//------------------------------------------------------------------------------
		...
		internal double Area(OutRec outRec) => Area(outRec.Pts);
		//------------------------------------------------------------------------------
	...
	public class ClipperOffset
	{
		...
		public void Execute(ref Paths solution, double delta)
		{
			...
			else
			{
				...
				clpr.Execute(ClipType.ctUnion, solution, PolyFillType.pftNegative,
