...
namespace WorldMapStrategyKit
{
	...
	public class TickerBand
	{
		...
		/// </summary>
		[Range(-0.5f, 0.5f)] public float verticalOffset;

		/// <summary>
		/// 0.01f .. 1.0f
		/// </summary>
		[Range(-0.01f, 1.0f)] public float verticalSize;

		/// <summary>
		/// Background color for the ticker band
		/// </summary>
		public Color backgroundColor = new(0, 0, 0, 0.9f);
		...
		/// </summary>
		[NonSerialized] public float alphaStart;

		[NonSerialized] public DateTime alphaTimer;
		[NonSerialized] public bool alphaChanging;
	}
}